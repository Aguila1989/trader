  ...
  lessons: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Siempre puedes consultar la estructura de comisiones vigente — y exactamente cómo gana dinero Atrium — en la página pública de Transparencia, enlazada en el pie de página de la aplicación. Si el modelo de comisiones cambia algún día, se publicará allí primero, antes de entrar en vigor.",
      ],
      example:
