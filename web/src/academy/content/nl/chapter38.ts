  ...
  lessons: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "De actuele fee-structuur — en precies hoe Atrium zijn geld verdient — vind je altijd op de publieke Transparantie-pagina, gelinkt in de voettekst van de app. Als er ooit iets aan het verdienmodel verandert, staat het daar eerst, vóór het ingaat.",
      ],
      example:
