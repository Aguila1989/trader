  ...
  lessons: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "You can always see the platform's current fee structure — and exactly how Atrium earns its money — on the public Transparency page, linked from the app's footer. If anything about the fee model ever changes, it is published there first, before it takes effect.",
      ],
      example:
