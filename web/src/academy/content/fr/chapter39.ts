  ...
  lessons: [
    {
      ...
      paragraphs: [
        ...
        "Vous choisissez aussi le modèle, pas seulement le fournisseur : dans Paramètres > Compte > Clé API IA se trouve un champ Modèle facultatif. Laissez-le vide et Atrium utilise un modèle par défaut raisonnable pour votre fournisseur ; renseignez un identifiant de modèle précis (par exemple une variante moins chère ou plus performante) et chaque requête IA s'exécute exactement sur ce modèle, à vos frais. Le bouton Tester la connexion vérifie l'identifiant du modèle avec votre clé, si bien qu'une faute de frappe échoue avant l'enregistrement plutôt qu'à votre première proposition de trade.",
      ],
      example:
