...
import { chapter38 as en38 } from "./content/en/chapter38";
import { chapter39 as en39 } from "./content/en/chapter39";
...
import { chapter38 as nl38 } from "./content/nl/chapter38";
import { chapter39 as nl39 } from "./content/nl/chapter39";
...
import { chapter38 as fr38 } from "./content/fr/chapter38";
import { chapter39 as fr39 } from "./content/fr/chapter39";
...
import { chapter38 as es38 } from "./content/es/chapter38";
import { chapter39 as es39 } from "./content/es/chapter39";
...
const EN: Chapter[] = [en01, en02, en03, en04, en05, en06, en07, en08, en09, en10, en11, withC12Ext(en12, "en"), en13, en14, en15, en16, en17, en18, en19, en20, en21, ...PENDING_EN, en38, en39];
const NL: Chapter[] = [nl01, nl02, nl03, nl04, nl05, nl06, nl07, nl08, nl09, nl10, nl11, withC12Ext(nl12, "nl"), nl13, nl14, nl15, nl16, nl17, nl18, nl19, nl20, nl21, ...PENDING_NL, nl38, nl39];
const FR: Chapter[] = [fr01, fr02, fr03, fr04, fr05, fr06, fr07, fr08, fr09, fr10, fr11, withC12Ext(fr12, "fr"), fr13, fr14, fr15, fr16, fr17, fr18, fr19, fr20, fr21, ...PENDING_FR, fr38, fr39];
const ES: Chapter[] = [es01, es02, es03, es04, es05, es06, es07, es08, es09, es10, es11, withC12Ext(es12, "es"), es13, es14, es15, es16, es17, es18, es19, es20, es21, ...PENDING_ES, es38, es39];
